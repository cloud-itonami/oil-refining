...
(defn collection
  [name]
  (str "com.etzhayyim.oil-refining." name))

(def cell-specs {
  :getrefinery {:legacy-cell "com-etzhayyim-apps-oilRefining-registry-getRefinery"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "getrefinery")]
     :required-gates common-gates
     :trigger "manifest cell getrefinery"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :listrefineries {:legacy-cell "com-etzhayyim-apps-oilRefining-registry-listRefineries"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listrefineries")]
     :required-gates common-gates
     :trigger "manifest cell listrefineries"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :listunits {:legacy-cell "com-etzhayyim-apps-oilRefining-registry-listUnits"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listunits")]
     :required-gates common-gates
     :trigger "manifest cell listunits"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :getyieldpressure {:legacy-cell "com-etzhayyim-apps-oilRefining-analytics-getYieldPressure"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "getyieldpressure")]
     :required-gates common-gates
     :trigger "manifest cell getyieldpressure"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :health {:legacy-cell "com-etzhayyim-apps-oilRefining-health"
     :phase :event
     :murakumo-node "reuben"
  ...
  :refinery {:legacy-cell "com-etzhayyim-apps-oilRefining-refinery"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :unit {:legacy-cell "com-etzhayyim-apps-oilRefining-unit"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "unit")]
     :required-gates common-gates
     :trigger "manifest cell unit"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :outage {:legacy-cell "com-etzhayyim-apps-oilRefining-outage"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "outage")]
     :required-gates common-gates
     :trigger "manifest cell outage"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
